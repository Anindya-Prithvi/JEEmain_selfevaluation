"""
Made by Anindya Prithvi. (s/o Biplab Kumar Naskar and Anindita Naskar).

This a program to help JEE aspirants track and analyze their performance.
"""
...
def auto_sav(fileis: str) -> None:

    savekey = open(fileis, "w")
    savekey.write(str(answer_key))


def attempt_counter(uint: int) -> int:
    count = 0
    for i in uint:
...
print(
    ...
    answer_key,
    "\n and this is the time taken in every question",
    time_key,
)
